                            ...
                            <form class="needs-validation" novalidate>
                                <div class="row form-row mb-3">
                                    <div class="col-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="kode_jenis" placeholder="Kode Jenis" value="097" disabled/>
                                    ...
                                    <div class="col-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="nama_jenis" placeholder="Jenis" defaultValue={'Makanan'} required/>
                                        <div class="valid-feedback">
                                            Looks good!
                                        </div>
                                    </div>
