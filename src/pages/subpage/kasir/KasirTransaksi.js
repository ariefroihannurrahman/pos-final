        ...
        <div className="container">
            <div className="row mb-5">
                ...
                <div className="col-6 mt-5">
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" className="form-control" id="bayar" value={bayar} onChangeCapture={changeBayar}/>
                    </div>
                    <div className="form-group">
            ...
            <div className="row">
                <div className="col mt-5">
                    <a href='/laporan-akhir' className="btn btn-primary float-start" onClick={TesId}>Logout</a>
